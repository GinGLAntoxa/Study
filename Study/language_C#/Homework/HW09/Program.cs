using System;
using System.Linq;
//Задача: Задайте одномерный массив из 10 целых чисел от 1 до 100. Найдите количество элементов массива, значения которых лежат в отрезке [10,90].
...
{ 
    ...
    public static void PrintResult(int[] array)
    {
        ...
        int countInRange = CountItemsRange(array, minRange, maxRange);
